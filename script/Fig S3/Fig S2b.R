...
##Corr y p-value
CorrB<-cor(Table[-c(1:95),c(4:12,14:24)], method = 'pearson')
p.matB <-cor_pmat(Table[-c(1:95),c(4:12,14:24)], method = 'pearson')

CorrNB<-cor(Table[c(1:95),c(4:12,14:24)], method = 'pearson')
p.matNB <-cor_pmat(Table[c(1:95),c(4:12,14:24)], method = 'pearson')
