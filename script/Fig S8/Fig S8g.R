...
####Lineal regression CCL and PCoA1 axis (Fig )
ggplot(data = PCoA_Comp_mean2, aes(CCL, mean.y, )) +
  geom_errorbarh(mapping = aes(xmin =CCL - CCL_ds ,xmax = CCL + CCL_ds),size = 0.2, alpha = 0.4) +
...
summary(lm(CCL~Axis.x, data = f))
#Multiple R-squared:  0.3141,	Adjusted R-squared:  0.2896 
#F-statistic: 12.82 on 1 and 28 DF,  p-value: 0.001277
