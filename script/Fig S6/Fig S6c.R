...
saveRDS(ps.pruned_taxa, "G:/My Drive/labs/Nottingham/Duckweed/Figuras paper/Clean data/Fig S4/Fig S4c/seqtab.rds")
seqtab <- readRDS("G:/My Drive/labs/Nottingham/Duckweed/Figuras paper/Clean data/Fig S4/Fig S4c/seqtab.rds")

#####PCoA for ASV-level data with Bray-Curtis
PCoA <- ordinate(ps.pruned_taxa, "PCoA", "bray")
...
x <- merge(x,ps.perc.3@sam_data, by=0)
