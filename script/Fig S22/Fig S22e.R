...
Metabolome <- read.table("list_log2foldchange Metabolites enhaced.txt", header = TRUE, row.names = 1)
...
corrX2262 = ggplot(Metabolome[Metabolome$Metabolite=='X2322',], #
...
summary(lm(log2foldchange~Complexity, data=Metabolome[Metabolome$Metabolite=='X2262',]))
