...
colnames(TablaCompleta) = c("Species","Microbiome","ID"                 
,"Nutrition","Subsample","CCL"       
,"Stele diameter","Endodermis diameter", "CCL1 diameter"      
,"CCL2 diameter","CCL3 diameter","CCL4 diameter"      
,"CCLe1 diameter","CCLe2 diameter","Root diameter"      
,"Stele N cell","Endodermis N cell","CCL1 N cell"        
,"CCL2 N cell","CCL3 N cell","CCL4 N cell"        
,"Exodermis_N_cell","Epidermis N cell","aerenchyma-like mean area"
,"aerenchyma-like N")
...
TablaCompleta = TablaCompleta[-c(77),]
...
log2foldchange_Table_Complete4$diff = as.numeric(log2foldchange_Table_Complete4$diff)
log2foldchange_Table_Complete4$Treatment = factor(log2foldchange_Table_Complete4$Treatment, c("NB","B+"))
plt_hmap = ggplot(data = log2foldchange_Table_Complete4, aes(var, Species_ID)) +
  ...
  scale_fill_paletteer_c("pals::kovesi.diverging_bwr_40_95_c42", #kovesi.diverging_bwr_55_98_c37
                         limits = c(-2,2),na.value = "#D9D9D9",name = "Fold Change") +
