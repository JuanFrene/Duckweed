...
##Corr y p-value
CorrB<-cor(TablaCompleta[-c(1:95),c(4:12,14:24)], method = 'pearson')
p.matB <-cor_pmat(TablaCompleta[-c(1:95),c(4:12,14:24)], method = 'pearson')

CorrNB<-cor(TablaCompleta[c(1:95),c(4:12,14:24)], method = 'pearson')
p.matNB <-cor_pmat(TablaCompleta[c(1:95),c(4:12,14:24)], method = 'pearson')
